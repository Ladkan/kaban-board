                ...
                >
                    ...
                    <div>
                        ...
                        <form.Field name="members">
                            {field =>(
                                <MemberPicker value={field.state.value} onChange={ids => field.handleChange(ids)} />
                            )}
                        </form.Field>
                    </div>
                    <div className="px-8 py-8 flex justify-end gap-4">
                            <button onClick={() => setNewModal(!newModal)} className="cursor-pointer px-8 py-3 text-on-surface-variant font-headline font-bold text-sm hover:text-on-surface transition-colors active:scale-95">
                                Cancel
                            </button>
